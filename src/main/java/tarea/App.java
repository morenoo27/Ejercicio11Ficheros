...
public class App {
    ...
    private static String[] descripciones = {"Aplicación destinada a la venta de ropa",
        "Aplicación destinada a la venta de coches",
        "Aplicación destinada a la venta de segunda mano",
        "Aplicación destinada a las redes sociales",
        "Aplicación destinada a guardar fotos en la nube",
        "Aplicación destinada a buscar citas",
        "Aplicación destinada a buscar trabajo",
        "Aplicación destinada a buscar lugares en una ciudad",
        "Aplicación destinada a encontrar vehículos por matrículas",
        "Aplicación destinada a juego de aviones"};

    /**
     * <html>
     * <pre>
     * Constructor que instancia un objeto de tipo "App" con todos sus atributos de clase null.
     * El unico que no esta en null es el codigo, ya que este se crea al instanciar el objeto,
     * y el nombre, ya que depende del numero que tenga el objeto.
     * Una vez se cree el objeto, se sumara uno en el contador para las futuras insttanciaciones
     * </pre>
     * </html>
     */
    public App() {
     ...
     * <html>
     * <pre>
     * Constructor parametrizado que crea el objeto a partir de los valores que recibe.
     * Aunque tenemos como atributo el codigo, no se recibe por parametro ya que
     * no hace falta al ser un contador estatico de la clase
     * </pre>
     *
     * @param codigoUnico Codigo de la app
     * @param descripcion Descripcion de la aplicacion
     * @param nombre Nombre de la App en este caso
     * @param tamaño Tamaño que pesa dicha App
     * @param fechaCreacion Fecha en la que se creo la aplicacion
     * </html>
     */
...
//  EQUALS & HASHCODE
    ...
    /**
     * Metodo que muestra todos los atributos de un objeto
     *
     * @return Secuencia con toda la informacio del objeto separada por comas
     */
    @Override
    public String toString() {
        ...
        return codigoUnico + "\t" + nombre + "\t" + tamanio + "\t" + fechaCreacion.format(formatoEspaniol);
    }
